...
public class BaseClass {
	...
	public void configBM() {
		...
		String username=pUtils.getPropertyData(IPathConstant.PROPFILE_PATH, "username");
		String password=pUtils.getPropertyData(IPathConstant.PROPFILE_PATH, "password");
